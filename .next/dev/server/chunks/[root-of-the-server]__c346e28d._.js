...
async function updateSchedule(params) {
    ...
    const runLegacy = async ()=>{
        ...
        if (legacyFields.length === 0) {
            const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$GA_NEXUS$2f$src$2f$lib$2f$engines$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("select id, branch_name, title, description, category, start_at, end_at, is_all_day, created_by, created_at from public.schedules where id = $1 and branch_name = $2", [
                id,
                branchName
            ]);
            const r = rows[0];
        ...
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$GA_NEXUS$2f$src$2f$lib$2f$engines$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`update public.schedules set ${legacyFields.join(", ")} where id = $${legacyFields.length + 1} and branch_name = $${legacyFields.length + 2} returning id, branch_name, title, description, category, start_at, end_at, is_all_day, created_by, created_at`, [
            ...legacyValues,
            id,
            branchName
        ]);
    ...
    try {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$GA_NEXUS$2f$src$2f$lib$2f$engines$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isColumnNotFound"])(err)) return runLegacy();
        throw err;
    }
}
async function deleteSchedule(params) {
    const { id, branchName } = params;
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$GA_NEXUS$2f$src$2f$lib$2f$engines$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("delete from public.schedules where id = $1 and branch_name = $2", [
        id,
        branchName
    ]);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c346e28d._.js.map