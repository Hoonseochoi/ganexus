...
(()=>{
    const e = new Error("Cannot find module '@/src/lib/engines/db'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/src/lib/engines/session'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
async function POST(req) {
    ...
    const rows = await query("select login_id, password, role, must_change_password from public.auth_users where login_id = $1", [
        loginId
    ]);
    const user = rows[0];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__041110cf._.js.map