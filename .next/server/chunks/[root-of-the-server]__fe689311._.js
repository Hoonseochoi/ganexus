module.exports=[18622,(e,t,a)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},70406,(e,t,a)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,t,a)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},95522,e=>e.a(async(t,a)=>{try{let t=await e.y("pg-d2edf3aec5ca8167");e.n(t),a()}catch(e){a(e)}},!0),54799,(e,t,a)=>{t.exports=e.x("crypto",()=>require("crypto"))},72707,e=>e.a(async(t,a)=>{try{var n=e.i(76022),r=e.i(7017),i=t([n,r]);async function o(){let e=await (0,r.getCurrentSession)();if(!e)return null;let[t,a]=await Promise.all([(0,n.query)("select login_id, role from public.auth_users where login_id = $1",[e.loginId]),(0,n.query)("select * from public.profiles where login_id = $1",[e.loginId])]),i=t[0];if(!i)return null;let o=a[0]??null;return{loginId:i.login_id,role:i.role,profile:o}}[n,r]=i.then?(await i)():i,e.s(["getCurrentUser",()=>o]),a()}catch(e){a(e)}},!1),63849,e=>e.a(async(t,a)=>{try{var n=e.i(76022),r=t([n]);async function i(e){try{let t=await (0,n.query)("select tenant_schema from public.profiles where branch_name = $1 and role = 'admin' and tenant_schema is not null limit 1",[e]);return t[0]?.tenant_schema??null}catch(e){if((0,n.isColumnNotFound)(e))return null;throw e}}async function o(e){let t,a=(t=e.employeeCode.replace(/[^a-zA-Z0-9]/g,"_").replace(/^_+|_+$/g,"")||"tenant",`t_${t}`.toLowerCase()),r=await n.pool.connect();try{await r.query(`create schema if not exists ${a}`),await r.query(`
    ...
    `),await r.query(`insert into ${a}.profiles (id, login_id, full_name, branch_name, phone_number, role, is_approved, company, email)
     ...
     on conflict (id) do update set login_id = excluded.login_id, full_name = excluded.full_name, branch_name = excluded.branch_name, phone_number = excluded.phone_number, role = excluded.role, is_approved = excluded.is_approved, manager_code = excluded.manager_code`,[e.profileId,e.loginId,e.fullName,e.branchName,e.phoneNumber,e.role,e.isApproved,e.managerCode??null])}[n]=r.then?(await r)():r,e.s(["addProfileToTenant",()=>l,"createTenantForAdmin",()=>o,"getTenantSchemaForBranch",()=>i]),a()}catch(e){a(e)}},!1),9458,e=>e.a(async(t,a)=>{try{var n=e.i(76022),r=e.i(63849),i=t([n,r]);async function o(e){return await (0,r.getTenantSchemaForBranch)(e)??"public"}async function l(e){let t=await o(e);try{return(await (0,n.query)(`
        ...
        limit 1
      `,[e]))[0]??null}catch(e){if((0,n.isRelationNotFound)(e))return console.warn("[notices] notices 테이블이 없습니다."),null;throw e}}async function d(e,t){let a=await o(t);try{return(await (0,n.query)(`
        select id, branch_name, title, body, image_url, created_by, created_at
        from ${a}.notices
        where id = $1 and branch_name = $2
      `,[e,t]))[0]??null}catch(e){if((0,n.isRelationNotFound)(e))return null;throw e}}async function s(e){let t=await o(e.branchName);return(await (0,n.query)(`
    ...
    `,[e.branchName,e.title,e.body??null,e.imageUrl??null,e.createdByProfileId]))[0]}async function u(e){let{id:t,branchName:a}=e,r=await o(a),i=[],l=[];if(void 0!==e.title&&(i.push(`title = $${l.length+1}`),l.push(e.title)),void 0!==e.body&&(i.push(`body = $${l.length+1}`),l.push(e.body)),void 0!==e.imageUrl&&(i.push(`image_url = $${l.length+1}`),l.push(e.imageUrl)),0===i.length)return d(t,a);try{return(await (0,n.query)(`
        update ${r}.notices
        set ${i.join(", ")}
    ...
    `,[e.noticeId,e.profileId])}async function p(e,t,a){let r=await o(e);try{return(await (0,n.query)(`select id from ${r}.notice_reads where notice_id = $1 and profile_id = $2`,[t,a])).length>0}catch(e){if((0,n.isRelationNotFound)(e))return!1;throw e}}async function m(e,t){let a=await o(e);try{return await (0,n.query)(`
      ...
      `,[t])}catch(e){if((0,n.isRelationNotFound)(e))return[];throw e}}[n,r]=i.then?(await i)():i,e.s(["createNotice",()=>s,"getLatestNoticeForBranch",()=>l,"getNoticeById",()=>d,"getNoticeReads",()=>m,"hasReadNotice",()=>p,"markNoticeRead",()=>c,"updateNotice",()=>u]),a()}catch(e){a(e)}},!1),51577,e=>e.a(async(t,a)=>{try{var n=e.i(78504),r=e.i(72707),i=e.i(9458),o=t([r,i]);async function l(e,{params:t}){let a=await (0,r.getCurrentUser)();if(!a)return n.NextResponse.json({message:"인증이 필요합니다."},{status:401});let o=a.profile;if(!o?.id)return n.NextResponse.json({message:"프로필이 없습니다."},{status:400});let{id:l}=await t;return await (0,i.getNoticeById)(l,o.branch_name??"")?(await (0,i.markNoticeRead)({branchName:o.branch_name??"",noticeId:l,profileId:o.id}),n.NextResponse.json({ok:!0})):n.NextResponse.json({message:"공지를 찾을 수 없습니다."},{status:404})}[r,i]=o.then?(await o)():o,e.s(["POST",()=>l]),a()}catch(e){a(e)}},!1),1013,e=>e.a(async(t,a)=>{try{var n=e.i(25515),r=e.i(13874),i=e.i(3337),o=e.i(28394),l=e.i(31003),d=e.i(74485),s=e.i(45387),u=e.i(48188),c=e.i(59590),p=e.i(55266),m=e.i(84379),h=e.i(66041),_=e.i(72827),f=e.i(33899),y=e.i(85787),x=e.i(93695);e.i(84790);var g=e.i(41779),w=e.i(51577),b=t([w]);[w]=b.then?(await b)():b;let R=new n.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/notices/[id]/read/route",pathname:"/api/notices/[id]/read",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/OneDrive/Desktop/GA_NEXUS/app/api/notices/[id]/read/route.ts",nextConfigOutput:"",userland:w}),{workAsyncStorage:N,workUnitAsyncStorage:q,serverHooks:C}=R;function v(){return(0,i.patchFetch)({workAsyncStorage:N,workUnitAsyncStorage:q})}async function $(e,t,a){R.isDev&&(0,o.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/notices/[id]/read/route";n=n.replace(/\/index$/,"")||"/";let i=await R.prepare(e,t,{srcPage:n,multiZoneDraftMode:!1});if(!i)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:w,params:b,nextConfig:v,parsedUrl:$,isDraftMode:N,prerenderManifest:q,routerServerContext:C,isOnDemandRevalidate:E,revalidateOnlyGenerated:k,resolvedPathname:A,clientReferenceManifest:T,serverActionsManifest:I}=i,P=(0,s.normalizeAppPath)(n),S=!!(q.dynamicRoutes[P]||q.routes[A]),j=async()=>((null==C?void 0:C.render404)?await C.render404(e,t,$,!1):t.end("This page could not be found"),null);if(S&&!N){let e=!!q.routes[A],t=q.dynamicRoutes[P];if(t&&!1===t.fallback&&!e){if(v.experimental.adapterPath)return await j();throw new x.NoFallbackError}}let O=null;!S||R.isDev||N||(O=A,O="/index"===O?"/":O);let U=!0===R.isDev||!S,z=S&&!U;I&&T&&(0,d.setManifestsSingleton)({page:n,clientReferenceManifest:T,serverActionsManifest:I});let F=e.method||"GET",H=(0,l.getTracer)(),D=H.getActiveScopeSpan(),M={params:b,prerenderManifest:q,renderOpts:{experimental:{authInterrupts:!!v.experimental.authInterrupts},cacheComponents:!!v.cacheComponents,supportsDynamicResponse:U,incrementalCache:(0,o.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:v.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,n,r)=>R.onRequestError(e,t,n,r,C)},sharedContext:{buildId:w}},B=new u.NodeNextRequest(e),K=new u.NodeNextResponse(t),L=c.NextRequestAdapter.fromNodeNextRequest(B,(0,c.signalFromNodeResponse)(t));try{let i=async e=>R.handle(L,M).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=H.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==p.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${F} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${F} ${n}`)}),d=!!(0,o.getRequestMeta)(e,"minimalMode"),s=async o=>{var l,s;let u=async({previousCacheEntry:r})=>{try{if(!d&&E&&k&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await i(o);e.fetchMetrics=M.renderOpts.fetchMetrics;let l=M.renderOpts.pendingWaitUntil;l&&a.waitUntil&&(a.waitUntil(l),l=void 0);let s=M.renderOpts.collectedTags;if(!S)return await (0,h.sendResponse)(B,K,n,M.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,_.toNodeOutgoingHttpHeaders)(n.headers);s&&(t[y.NEXT_CACHE_TAGS_HEADER]=s),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==M.renderOpts.collectedRevalidate&&!(M.renderOpts.collectedRevalidate>=y.INFINITE_CACHE)&&M.renderOpts.collectedRevalidate,r=void 0===M.renderOpts.collectedExpire||M.renderOpts.collectedExpire>=y.INFINITE_CACHE?void 0:M.renderOpts.collectedExpire;return{value:{kind:g.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==r?void 0:r.isStale)&&await R.onRequestError(e,t,{routerKind:"App Router",routePath:n,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:z,isOnDemandRevalidate:E})},!1,C),t}},c=await R.handleResponse({req:e,nextConfig:v,cacheKey:O,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:q,isRoutePPREnabled:!1,isOnDemandRevalidate:E,revalidateOnlyGenerated:k,responseGenerator:u,waitUntil:a.waitUntil,isMinimalMode:d});if(!S)return null;if((null==c||null==(l=c.value)?void 0:l.kind)!==g.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(s=c.value)?void 0:s.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});d||t.setHeader("x-nextjs-cache",E?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),N&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let p=(0,_.fromNodeOutgoingHttpHeaders)(c.value.headers);return d&&S||p.delete(y.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||p.get("Cache-Control")||p.set("Cache-Control",(0,f.getCacheControlHeader)(c.cacheControl)),await (0,h.sendResponse)(B,K,new Response(c.value.body,{headers:p,status:c.value.status||200})),null};D?await s(D):await H.withPropagatedContext(e.headers,()=>H.trace(p.BaseServerSpan.handleRequest,{spanName:`${F} ${n}`,kind:l.SpanKind.SERVER,attributes:{"http.method":F,"http.target":e.url}},s))}catch(t){if(t instanceof x.NoFallbackError||await R.onRequestError(e,t,{routerKind:"App Router",routePath:P,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:z,isOnDemandRevalidate:E})},!1,C),S)throw t;return await (0,h.sendResponse)(B,K,new Response(null,{status:500})),null}}e.s(["handler",()=>$,"patchFetch",()=>v,"routeModule",()=>R,"serverHooks",()=>C,"workAsyncStorage",()=>N,"workUnitAsyncStorage",()=>q]),a()}catch(e){a(e)}},!1)];

//# sourceMappingURL=%5Broot-of-the-server%5D__fe689311._.js.map