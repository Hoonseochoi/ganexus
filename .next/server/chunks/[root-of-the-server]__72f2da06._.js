     ...
     on conflict (id) do update set login_id = excluded.login_id, full_name = excluded.full_name, branch_name = excluded.branch_name, phone_number = excluded.phone_number, role = excluded.role, is_approved = excluded.is_approved, manager_code = excluded.manager_code`,[e.profileId,e.loginId,e.fullName,e.branchName,e.phoneNumber,e.role,e.isApproved,e.managerCode??null])}[n]=r.then?(await r)():r,e.s(["addProfileToTenant",()=>o,"createTenantForAdmin",()=>i,"getTenantSchemaForBranch",()=>l]),a()}catch(e){a(e)}},!1),69910,e=>e.a(async(t,a)=>{try{var n=e.i(76022),r=e.i(63849),l=t([n,r]);[n,r]=l.then?(await l)():l;let m={education:"dealer",vacation:"leave",hq:"internal",etc:"etc"},p={dealer:"education",internal:"hq",personal:"etc",leave:"vacation",etc:"etc"};async function i(e){let{branchName:t,from:a,to:l}=e,i=await (0,r.getTenantSchemaForBranch)(t)??"public";console.log(`[schedules] listSchedulesForBranch: branch=${t}, schema=${i}`);let o=["branch_name = $1"],s=[t];a&&(o.push("end_at >= $2"),s.push(a)),l&&(o.push("start_at <= $"+(s.length+1)),s.push(l));let d=o.join(" and ");try{return(await (0,n.query)(`
      ...
      `,[e.scheduleId,e.branchName])}catch(e){if((0,n.isRelationNotFound)(e))return[];throw e}}async function c(e){let{id:t,branchName:a}=e,l=await (0,r.getTenantSchemaForBranch)(a)??"public",i=[],o=[];function d(e,t){i.push(`${e} = $${i.length+1}`),o.push(t)}void 0!==e.title&&d("title",e.title),void 0!==e.description&&d("description",e.description),void 0!==e.category&&d("category",e.category),void 0!==e.dealerName&&d("dealer_name",e.dealerName),void 0!==e.location&&d("location",e.location),void 0!==e.instructor&&d("instructor",e.instructor),void 0!==e.targetAudience&&d("target_audience",e.targetAudience),void 0!==e.managerName&&d("manager_name",e.managerName),void 0!==e.startAt&&d("start_at",e.startAt),void 0!==e.endAt&&d("end_at",e.endAt),void 0!==e.isAllDay&&d("is_all_day",e.isAllDay);let c=null;try{c=(await (0,n.query)(`select id, branch_name, title, description, category, dealer_name, location, instructor, target_audience, manager_name, start_at, end_at, is_all_day, created_by, created_at from ${l}.schedules where id = $1 and branch_name = $2`,[t,a]))[0]??null}catch(e){if(!(0,n.isColumnNotFound)(e))throw e;c=null}let u=async()=>0===i.length?(await (0,n.query)(`select id, branch_name, title, description, category, dealer_name, location, instructor, target_audience, manager_name, start_at, end_at, is_all_day, created_by, created_at from ${l}.schedules where id = $1 and branch_name = $2`,[t,a]))[0]??null:(await (0,n.query)(`update ${l}.schedules set ${i.join(", ")} where id = $${i.length+1} and branch_name = $${i.length+2} returning id, branch_name, title, description, category, dealer_name, location, instructor, target_audience, manager_name, start_at, end_at, is_all_day, created_by, created_at`,[...o,t,a]))[0]??null,_=async()=>{let r=[],i=[];function o(e,t){r.push(`${e} = $${r.length+1}`),i.push(t)}if(void 0!==e.title&&o("title",e.title),void 0!==e.description&&o("description",e.description),void 0!==e.category&&o("category",p[e.category]),void 0!==e.startAt&&o("start_at",e.startAt),void 0!==e.endAt&&o("end_at",e.endAt),void 0!==e.isAllDay&&o("is_all_day",e.isAllDay),0===r.length){let e=(await (0,n.query)(`select id, branch_name, title, description, category, start_at, end_at, is_all_day, created_by, created_at from ${l}.schedules where id = $1 and branch_name = $2`,[t,a]))[0];return e?{...e,category:m[e.category],dealer_name:null,location:null,instructor:null,target_audience:null,manager_name:null,target_full_name:null,target_avatar_url:null}:null}let s=(await (0,n.query)(`update ${l}.schedules set ${r.join(", ")} where id = $${r.length+1} and branch_name = $${r.length+2} returning id, branch_name, title, description, category, start_at, end_at, is_all_day, created_by, created_at`,[...i,t,a]))[0];return s?{...s,category:m[s.category],dealer_name:null,location:null,instructor:null,target_audience:null,manager_name:null,target_full_name:null,target_avatar_url:null}:null};try{let n=await u();return c&&n&&await s({schema:l,scheduleId:t,branchName:a,modifiedBy:e.modifiedBy,modifiedByName:e.modifiedByName??null,before:c,after:n}),n}catch(r){if((0,n.isColumnNotFound)(r)){let n=await _();return c&&n&&await s({schema:l,scheduleId:t,branchName:a,modifiedBy:e.modifiedBy,modifiedByName:e.modifiedByName??null,before:c,after:n}),n}throw r}}async function u(e){let{id:t,branchName:a,hardDelete:l}=e,i=await (0,r.getTenantSchemaForBranch)(a)??"public";l?await (0,n.query)(`delete from ${i}.schedules where id = $1 and branch_name = $2`,[t,a]):await (0,n.query)(`update ${i}.schedules set is_soft_deleted = true where id = $1 and branch_name = $2`,[t,a])}async function _(e){let{id:t,branchName:a}=e,l=await (0,r.getTenantSchemaForBranch)(a)??"public";try{return(await (0,n.query)(`select s.id, s.branch_name, s.title, s.description, s.category,
       ...
       limit 1`,[t,a]))[0]??null}catch(e){if((0,n.isRelationNotFound)(e))return console.warn("[schedules] schedules 테이블이 없어 null을 반환합니다."),null;if((0,n.isColumnNotFound)(e)){console.warn("[schedules] getScheduleById: 컬럼 누락 → instructor만 읽는 최소 쿼리로 재시도");try{let e=(await (0,n.query)(`select s.id, s.branch_name, s.title, s.description, s.category,
         ...
         left join public.profiles p on s.created_by::text = p.id::text
         where s.id = $1 and s.branch_name = $2
         limit 1`,[t,a]))[0];if(!e)return null;return{...e,category:m[e.category]||e.category,dealer_name:null,location:null,instructor:null,target_audience:null,manager_name:"vacation"===e.category?e.title:null,target_full_name:"vacation"===e.category?e.title:null,target_avatar_url:null}}throw e}}e.s(["createSchedule",()=>o,"deleteSchedule",()=>u,"getScheduleById",()=>_,"getScheduleEditLogs",()=>d,"listSchedulesForBranch",()=>i,"updateSchedule",()=>c]),a()}catch(e){a(e)}},!1),11660,e=>e.a(async(t,a)=>{try{var n=e.i(78504),r=e.i(72707),l=e.i(69910),i=t([r,l]);async function o(e,{params:t}){let{id:a}=await t,i=await (0,r.getCurrentUser)();if(!i)return n.NextResponse.json({message:"인증이 필요합니다."},{status:401});let o=i.profile?.branch_name;if(!o)return n.NextResponse.json({message:"지점 정보가 설정되지 않았습니다."},{status:400});let s=await (0,l.getScheduleEditLogs)({scheduleId:a,branchName:o});return n.NextResponse.json({logs:s})}[r,l]=i.then?(await i)():i,e.s(["GET",()=>o,"dynamic",0,"force-dynamic"]),a()}catch(e){a(e)}},!1),75024,e=>e.a(async(t,a)=>{try{var n=e.i(25515),r=e.i(13874),l=e.i(3337),i=e.i(28394),o=e.i(31003),s=e.i(74485),d=e.i(45387),c=e.i(48188),u=e.i(59590),_=e.i(55266),m=e.i(84379),p=e.i(66041),h=e.i(72827),y=e.i(33899),f=e.i(85787),g=e.i(93695);e.i(84790);var b=e.i(41779),x=e.i(11660),w=t([x]);[x]=w.then?(await w)():w;let R=new n.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/schedules/[id]/logs/route",pathname:"/api/schedules/[id]/logs",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/OneDrive/Desktop/GA_NEXUS/app/api/schedules/[id]/logs/route.ts",nextConfigOutput:"",userland:x}),{workAsyncStorage:N,workUnitAsyncStorage:q,serverHooks:A}=R;function $(){return(0,l.patchFetch)({workAsyncStorage:N,workUnitAsyncStorage:q})}async function v(e,t,a){R.isDev&&(0,i.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/schedules/[id]/logs/route";n=n.replace(/\/index$/,"")||"/";let l=await R.prepare(e,t,{srcPage:n,multiZoneDraftMode:!1});if(!l)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:x,params:w,nextConfig:$,parsedUrl:v,isDraftMode:N,prerenderManifest:q,routerServerContext:A,isOnDemandRevalidate:C,revalidateOnlyGenerated:E,resolvedPathname:S,clientReferenceManifest:T,serverActionsManifest:j}=l,F=(0,d.normalizeAppPath)(n),k=!!(q.dynamicRoutes[F]||q.routes[S]),B=async()=>((null==A?void 0:A.render404)?await A.render404(e,t,v,!1):t.end("This page could not be found"),null);if(k&&!N){let e=!!q.routes[S],t=q.dynamicRoutes[F];if(t&&!1===t.fallback&&!e){if($.experimental.adapterPath)return await B();throw new g.NoFallbackError}}let I=null;!k||R.isDev||N||(I=S,I="/index"===I?"/":I);let P=!0===R.isDev||!k,D=k&&!P;j&&T&&(0,s.setManifestsSingleton)({page:n,clientReferenceManifest:T,serverActionsManifest:j});let O=e.method||"GET",z=(0,o.getTracer)(),U=z.getActiveScopeSpan(),H={params:w,prerenderManifest:q,renderOpts:{experimental:{authInterrupts:!!$.experimental.authInterrupts},cacheComponents:!!$.cacheComponents,supportsDynamicResponse:P,incrementalCache:(0,i.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:$.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,n,r)=>R.onRequestError(e,t,n,r,A)},sharedContext:{buildId:x}},M=new c.NodeNextRequest(e),L=new c.NodeNextResponse(t),K=u.NextRequestAdapter.fromNodeNextRequest(M,(0,u.signalFromNodeResponse)(t));try{let l=async e=>R.handle(K,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=z.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==_.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${O} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${O} ${n}`)}),s=!!(0,i.getRequestMeta)(e,"minimalMode"),d=async i=>{var o,d;let c=async({previousCacheEntry:r})=>{try{if(!s&&C&&E&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await l(i);e.fetchMetrics=H.renderOpts.fetchMetrics;let o=H.renderOpts.pendingWaitUntil;o&&a.waitUntil&&(a.waitUntil(o),o=void 0);let d=H.renderOpts.collectedTags;if(!k)return await (0,p.sendResponse)(M,L,n,H.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,h.toNodeOutgoingHttpHeaders)(n.headers);d&&(t[f.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=f.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,r=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=f.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:b.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==r?void 0:r.isStale)&&await R.onRequestError(e,t,{routerKind:"App Router",routePath:n,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:D,isOnDemandRevalidate:C})},!1,A),t}},u=await R.handleResponse({req:e,nextConfig:$,cacheKey:I,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:q,isRoutePPREnabled:!1,isOnDemandRevalidate:C,revalidateOnlyGenerated:E,responseGenerator:c,waitUntil:a.waitUntil,isMinimalMode:s});if(!k)return null;if((null==u||null==(o=u.value)?void 0:o.kind)!==b.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==u||null==(d=u.value)?void 0:d.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",C?"REVALIDATED":u.isMiss?"MISS":u.isStale?"STALE":"HIT"),N&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let _=(0,h.fromNodeOutgoingHttpHeaders)(u.value.headers);return s&&k||_.delete(f.NEXT_CACHE_TAGS_HEADER),!u.cacheControl||t.getHeader("Cache-Control")||_.get("Cache-Control")||_.set("Cache-Control",(0,y.getCacheControlHeader)(u.cacheControl)),await (0,p.sendResponse)(M,L,new Response(u.value.body,{headers:_,status:u.value.status||200})),null};U?await d(U):await z.withPropagatedContext(e.headers,()=>z.trace(_.BaseServerSpan.handleRequest,{spanName:`${O} ${n}`,kind:o.SpanKind.SERVER,attributes:{"http.method":O,"http.target":e.url}},d))}catch(t){if(t instanceof g.NoFallbackError||await R.onRequestError(e,t,{routerKind:"App Router",routePath:F,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:D,isOnDemandRevalidate:C})},!1,A),k)throw t;return await (0,p.sendResponse)(M,L,new Response(null,{status:500})),null}}e.s(["handler",()=>v,"patchFetch",()=>$,"routeModule",()=>R,"serverHooks",()=>A,"workAsyncStorage",()=>N,"workUnitAsyncStorage",()=>q]),a()}catch(e){a(e)}},!1)];
